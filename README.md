...
The reports are also compiled into static HTML dashboard files in `docs/`. GitHub Pages deployment is currently disabled; the HTML files are retained for local inspection and possible future deployment.
